<template>
	<div class="app">
		<header class="app__title">
			<h1>
				<Roller text="Zameen Play" :charList="stringCharList" :transition="2" :isStatic="true" class="roller"></Roller>
			</h1>
			<div class="app__title__action">
				<span style="font-size:35px;">Coming Soon..</span>
			</div>
		</header>
		<footer class="app__footer">ZameenPlay, Copyright © 2020 ZameenPlay.com</footer>
	</div>
</template>
...
.app {
	...
	align-items: center;
	background: linear-gradient(to bottom right, #2D1674, #2C1472); //#2D1674;
	.app__title {
		position: relative;
		...
		background-color: linear-gradient(to bottom right, #2D1674, #2C1472); //#2D1674;
		background: url("assets/bg3.gif") no-repeat center;
		color: white;
